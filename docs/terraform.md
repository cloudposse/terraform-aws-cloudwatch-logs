...
|------|-------------|------|---------|:--------:|
| additional\_permissions | Additional permissions granted to assumed role | `list` | <pre>[<br>  "logs:CreateLogStream",<br>  "logs:DeleteLogStream"<br>]</pre> | no |
...
| stream\_names | Names of streams | `list` | `[]` | no |
